      ...
      <section className="hero__area-2">
        <div className="hero__inner-2">
          ...
          <div className="hero__text-2">
            <p>
              We handle everything — pickup in the USA, customs clearance, ocean
              transport, and delivery in Saudi Arabia. Whether you choose
              roll-on/roll-off (RoRo) or a secure container.
            </p>
            <div className="hero__button btn_wrapper" ref={btnWrapper}>
              <Link href="/service" className="wc-btn-pink btn-hover btn-item">
                <span></span>
                call <br />
                booking <i className="fa-solid fa-arrow-right"></i>
              </Link>
            </div>
          </div>
        </div>
